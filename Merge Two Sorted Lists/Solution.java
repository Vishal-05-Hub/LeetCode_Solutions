...
// Approach use----------> Using the concept of singly linnked list operations using .val and .next
class Solution {
    public ListNode mergeTwoLists(ListNode l1, ListNode l2) {
        ...
        // Create a new linked list of tupe ListNode named headNode that will go through both the L.L and combine them in sorted order
        ListNode headNode;
